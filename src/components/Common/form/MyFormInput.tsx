  ...
  return (
    <div className={cn("flex flex-col gap-1", className)}>
      {label && (
        <label
          htmlFor={name}
          className={cn("font-normal mb-1", labelClassName)}
        >
          {label}
        </label>
      )}
            ...
            {type === "file" ? (
              <div className="flex flex-col gap-2">
                <label
                  htmlFor={name}
                  className={cn(
                    "border border-white rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-600 transition-colors relative overflow-hidden",
                    "min-h-[100px]",
              ...
              <textarea
                ...
                disabled={disabled}
                className={cn(
                  "w-full px-4 py-3 font-normal rounded-md focus:outline-none focus:ring-2 border !border-white  text-white",
